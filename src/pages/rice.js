...
export default () => 
    ...
    <Layout>
        ...
        <body>
        <h1>Rice</h1>
            <p>Rice, family name Oryza, is a globally consumed grain, largely consisting of carbohydrates, rice is essential to many cuisines around the world. As a grain, it is inexpensive, widely available, easy to cook, good-tasting, and substantial, making it the perfect food for many people. 
</p>
            <h4>Varieties</h4>
                <p>
                  There are numerous rice varieties, most of which are relatively similar in taste and nutrition. They are often classified into groups based on their length. They are divided into: <strong>Short-grain, Medium-grain, and Long-grain.</strong>  
                  <ul>
            ...
            <h4>Economics</h4>
                <p>Rice is primarily produced in Southern and Central Asia, where it is also primarily consumed. The top five largest producers of rice are China, India, Indonesia, Bangladesh, and Vietnam, from most tons of rice produced to least. These nations produce a combined yield of over 500 million tons of rice annually. Worldwide, rice is the third most consumed grain, just behind corn and wheat.
</p>
            <h4>Optimal Conditions</h4>
                <p>The rice plant is highly dependent on water, and is usually grown in fields flooded with water to ensure that water is constantly available to the plant. Generally, these plants thrive in warm environments with plenty of sunlight, with the temperature reaching at least 70 degrees Fahrenheit or about 21 degrees Celsius. The soil should be slightly acidic, and preferably be able to retain water, like clay. Your region is especially important, because the rice plant needs heat for a sustained period of time, lasting up to six months.
</p>
            <h4>Planting</h4>
                <p>Growing and planting rice may seem intimidating at first, however it is relatively simple. First, obtain rice seeds. Rice from the grocery store will not work, as most varieties sold in stores are heavily processed. To begin planting, soak seeds in water for a day to break the seeds’ dormant state. Then, either choose to plant directly into the ground or consider growing seedlings to later transplant. Transplantation is more labor intensive, however, it yields crops with a lesser need for weed control, and is a popular method of rice cultivation in Asian countries. To prepare the ground for plantation, clear out all weeds by plucking them from the root, and till the soil, ensuring that the soil is somewhat consistant and mixed evenly. Planting in a bucket, pot, or other small container may be the better choice for individuals seeking to try out growing rice for the first time. This allows you to have a higher degree of control in the amount of water the plants receive. If you intend to plant rice on a large scale, ensure that you have created a field with rows to grow rice, and sunken rows to accommodate water to flood the field. These divots should span the entire row of crops, and hold between 2 and 9 inches of water, depending on the size, variety, and location of the plants. After 2-3 weeks, fertilize the rice crops, and they will continue to grow. They take 3-6 months to reach maturity, depending on weather and variety of rice.
</p>
            <h4>Harvest</h4>
                <p>The harvest process for the rice plant is time consuming and labor intensive. First, the field must be drained of the floods, and allowed to dry somewhat. Then, the plants are to be cut by hand or machine, and allowed to dry. Following the drying of the plants, the rice is repeatedly slammed upon a surface, freeing whole grains from the plant, and allowing them to seep through perforations. Then, the unprocessed grains are once again dried, and can be roasted. Following this process, the grains are milled down to remove the hull, and depending on the type of rice desired, some grains are processed down until the bran and germ is removed, creating white rice. 
</p>
            <h4>Fertilization and Soil Care</h4>
                <p>In maintaining soil and ensuring that crops receive the correct nutrients, fertilization is essential. The rice crop has been shown to benefit from the use of nitrogen and phosphorus fertilizer. Nitrogen is the nutrient that is required by the crop in the highest amounts.
</p>
            <h4>Other info</h4>
